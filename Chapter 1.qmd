...
$$
\begin{aligned} 
& \sum M_A=T \sin (30^{\circ}) * 3{~ft}-1,200{~lb }*2{~ft}=0\\
& T = 1,600 {~lb} \\
& \sum F_x=-A_x-T \cos (30^{\circ})=0\\
& \sum F_x=-A_x-1,600{~lb} \cos (30^{\circ})=0\\
& A_x=-1,384.6{~lb} \\
& \sum F_y=A_y+T \sin (30^{\circ})-1200{~lb}=0\\
& \sum F_y=A_y+1,600{~lb} \sin (30^{\circ})-1200{~lb}=0\\
&A_y= 400{~lb}
\end{aligned}
$$
...
![](images/Updated%20CH1%20examples/example%201.2%20part%204.png){fig-align="center" width="451"}
...
Determine the forces in members ED and EF. Let F~1~ = 8 kN and F~2~ = 12 kN.
...
&\sum F_x=-B C-C D \cos \left(78.7^{\circ}\right)=0 \quad\rightarrow\quad B C=-2.39{~kN}
\end{aligned}
$$
