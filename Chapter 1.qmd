...
# Introduction and Statics Review {#sec-statics}
...
Solving (1) for F~A~ yields F~A~ = 1,154.7 N

Subbing this result into (1) and (2) yields C~x~ = -577.4 N and C~y~ = 1,000 N
...
**Answer: F~DC~ = 6 kN (Compressive), F~EF~ = 18 kN (Tensile)**
:::
