...
![Positive sign convention for internal shear force (V) and bending moment (M)](images/CH7%20PNGs/figure%207.3.png){#fig-7.2 fig-align="center" width="286"}
...
One way to find internal shear and bending forces is to cut sections and analyze the free-body diagrams, as we did in previous chapters of this book. The first step for a statically determinate (all forces can be found using only equilibrium equations) beam is to find the external reactions. To determine the internal forces at any point along the beam, cut the section at that point and draw the free-body diagram from that point to one end of the beam. We will include the internal shear force, V, and internal bending moment, M, at the cut section and then use equilibrium equations to solve for those internal loads. This process is demonstrated in @exm-7.1.
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.1%20part%201.png){fig-align="center" width="357"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.1%20part%202.png){fig-align="center" width="356"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.1%20part%203.png){fig-align="center" width="346"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.1%20part%204.png){fig-align="center" width="344"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.1%20part%205.png){fig-align="center" width="348"}
...
-   The slope of the shear diagram is equal to the sign and magnitude of the distributed load. If there is no load on a section of the beam then the slope of the shear diagram would be zero.
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.2%20part%201.png){fig-align="center" width="365"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.2%20part%202.png){fig-align="center" width="365"}
...
![](images/June%2013%20figure%20edits/example%207.2%20part%203.png){fig-align="center" width="374"}
...
![](images/June%2013%20figure%20edits/example%207.2%20part%204.png){fig-align="center" width="366"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.2%20part%205.png){fig-align="center" width="367"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.2%20part%207.png){fig-align="center" width="329"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.2%20part%208.png){fig-align="center" width="326"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.2%20part%209.png){fig-align="center" width="333"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.2%20part%2010.png){fig-align="center" width="311"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.3%20part%201.png){fig-align="center" width="345"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.3%20part%202.png){fig-align="center" width="344"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.3%20part%203.png){fig-align="center" width="342"}

**Section between A and B**

![](images/chapter%207%20figure%20updates%20post%20review/example%207.3%20part%204.png){fig-align="center" width="342"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.3%20part%205.png){fig-align="center" width="300"}
...
We can see that in this example, the entire length of the beam is subjected to negative moment. Going back to our sign convention from the beginning of this chapter, a negative moment indicates a concave down behavior. When we look at the beam and the external loads it makes sense as the beam will want to bend concave down, as shown in the figure.

![](images/chapter%207%20figure%20updates%20post%20review/example%207.3%20part%206.png){fig-align="center" width="284"}
:::
::::
:::::
...
Specifically, we saw in @sec-7.2 that $\frac{dV}{dx}=w$ and $\frac{dM}{dx}=V$. That is, the slope of the shear force diagram at any point equals the applied distributed load at that point and tThe slope of the bending moment diagram at any point equals the shear force at that point.

Further, any applied concentrated force causes a jump in the shear diagram—an upward force results in an upward jump. Any applied couples causes a jump in the bending moment diagram—a clockwise moment causes an upward jump. This allows us to draw the shape of the shear force diagram based on the applied loads, and the shape of the bending moment diagram based on the shear force diagram.
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.5%20part%201.png){fig-align="center" width="356"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.5%20part%202.png){fig-align="center" width="378"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.5%20part%203.png){fig-align="center" width="407"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.5%20part%204.png){fig-align="center" width="376"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.5%20part%205.png){fig-align="center" width="376"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.5%20part%206.png){fig-align="center" width="374"}
...
![](images/chapter%207%20figure%20updates%20post%20review/example%207.5%20part%207.png){fig-align="center" width="385"}
...
3.  Once the shear force diagram is complete, use it to draw the bending moment diagram. Begin at the left end of the beam and move to the right, obeying these rules
    ...
    -   An applied couple causes a discontinuity on the moment diagram. A clockwise couple causes a jump upwards and a counterclockwise couple causes a jump down.
