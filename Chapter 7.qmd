...
![Examples of structural beams](images/CH7 PNGs/7.1 new.png){#fig-7.1 fig-align="center"}
...
![](images/CH7%20PNGs/example%207.1%20part%201%202.png){fig-align="center" width="357"}
...
## Determining Equations by Equilibrium and Equations {#sec-7.3}
...
@exm-7.2 illustrates this method.
...
When the loading is relatively simple, consisting of concentrated forces, concentrated moments, and uniformly distributed loads, we can use geometry to find the area of the load and shear diagrams since the shapes are simple. @exm-7.3 and @exm-7.4 illustrate this method.
