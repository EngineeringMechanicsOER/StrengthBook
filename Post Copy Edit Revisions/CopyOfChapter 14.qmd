...
Note that the determination of internal reactions for the general problems presented in this chapter will require the use of 3D equilibrium equations, particularly for determining bending moments and torsion. You may find it helpful to review @sec-1.3 to understand these calculations.
...
![The distances d~H~ and d~V~ that would go in \@eq-14.1 when calculating the bending stress for the example point P on the cross-section](images/chapter%2014%20figure%20edits/figure%2014.3.png){#fig-14.3 fig-align="center" width="236"}
...
![](images/example%2014.6%20part%206.png){fig-align="center" width="242"}
