...
2.  Determine the section properties of the beam. This will require knowing the location of the **centroid**, **neutral axis**, and the **moment of inertia**. (Review of this is in @sec-geometric-properties of this text or a table listing values of I for selected common shapes is in the Appendix.)
