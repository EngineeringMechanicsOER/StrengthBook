...
![Two example beams showing the undeflected position of the centerline (dotted line) and the deflected position (elastic curve) of the beam (solid line).](images/CH11%20PNGs/11.2.png){#fig-11.2 fig-align="center" width="482"}
...
This equation describes the exact deflection $(y)$ at any distance $(x)$ along the beam for elastic deformations. In most engineering applications the deflection $(y)$ is very small. We can simplify this equation significantly by assuming that our deflection $(y)$ will be small and thus that $\frac{d y}{d x}$ is very small and $\left(\frac{d y}{d x}\right)^{2}$ is negligible. This simplifies the equation to
...
![At pin and roller supports, the deflection is zero but the slope is not. At a fixed support, both the slope and deflection are zero. For a statically determinate beam in equilibrium we will always have two boundary conditions.](images/CH11%20PNGs/11.3.png){#fig-11.3 fig-align="center" width="615"}
...
![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.1%20part%201.png){fig-align="center" width="245"}
...
![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.1%20part%202.png){fig-align="center" width="249"}
...
![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.1%20part%203.png){fig-align="center" width="245"}

![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.1%20part%204.png){fig-align="center" width="244"}
...
![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.2%20part%201.png){fig-align="center" width="247"}
...
![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.2%20part%202.png){fig-align="center" width="248"}

![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.2%20part%203.png){fig-align="center" width="246"}
...
This text will consider deflection of beams made of a single material with uniform cross-sections (i.e. elastic modulus, E, and 2nd moment of area, I, remain constant). In practice, changes in E and I also necessitate additional separate equations for each change.

@fig-11.4 shows a beam with two loading regions. To fully describe the deflection in this beam we will need to determine 2 internal bending moment equations - one in segment AB and one in segment BC. Each equation will be integrated twice, thereby introducing four constants of integration. Two of these can still be determined by using boundary conditions, but we still need to determine the other two. This is done with continuity conditions.

![The loading on the simply supported beam is different in segment AB than in segment BC. Each segment has its own bending moment equation that must be found and integrated.](images/CH11%20PNGs/example11.3-1.png){#fig-11.4 fig-align="center" width="257"}
...
![](images/June%2013%20figure%20edits/example%2011.3%20part%201.png){fig-align="center" width="250"}
...
![](images/June%2013%20figure%20edits/example%2011.3%20part%202.png){fig-align="center" width="247"}
...
![](images/June%2013%20figure%20edits/example%2011.3%20part%203.png){fig-align="center" width="247"}

![](images/June%2013%20figure%20edits/example%2011.3%20part%204.png){fig-align="center" width="241"}
...
![](images/June%2013%20figure%20edits/example%2011.3%20part%205.png){fig-align="center" width="242"}

![](images/June%2013%20figure%20edits/example%2011.3%20part%206.png){fig-align="center" width="242"}
...
\text { At } x_2=9, y_2=0 \quad \rightarrow \quad &\frac{360(9)^2}{2}-\frac{40(4)^3}{6}+c_3(9) +C_4=0 \\ & c_4=-9 c_3-9720\end{aligned}
$$

Apply continuity conditions at the point where the loading changes (x~1~ = x~2~ = 6 m):

$$
\begin{gathered} \text { At } x_1=x_2=6 \mathrm{~m}, \frac{\partial y_1}{\partial x_1}=\frac{\partial y_2}{\partial x_2} \\ \frac{80(6)^2}{2}-\frac{10(6)^3}{3}+c_1=360(6)-\frac{40(6)^2}{2}+c_3 \\ 1440-720+c_1=2160-720+c_3 \\ C_1=720+C_3 \\ \\  \text { At } x_1=x_2=6 \mathrm{~m}, y_1=y_2 \\ \frac{80(6)^3}{6}-\frac{10(6)^4}{12}+c_1(6)=\frac{360(6)^2}{2} - \frac{40(6)^3}{6}+c_3(6) +C_4 \\ 2880-1080+6 C_1=6480-1440+6 C_3+C_4 \\ 1800+6 C_1=5040+6 C_3+C_4 \\\end{gathered}
$$
...
It is not required that we make both cuts from the left. In some cases it may be easier to make one cut from the left and the other from the right. Consider the beam in @fig-11.5. When making a cut in the region not under the distributed load, a free body diagram to the left of the cut has many more forces than a free body diagram of the right side.

![Simple beam showing two options for finding the internal bending moment. Note that the moment equation will be much simpler if we draw the right hand side of the cut.](images/Chapter%2011%20image%20edits%20post%20review/figure%2011.5.png){#fig-11.5 fig-align="center" width="485"}
...
![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.3%20(reworked)%20part%201.png){fig-align="center" width="269"}
...
![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.3%20(reworked)%20part%202.png){fig-align="center" width="224"}
...
\\
\frac{80(6)^3}{6}-\frac{10(6)^4}{12}+ c_1(6)=\frac{40(3)^3}{6}+c_3(3) \\ 2880-1080+6 c_1=180+3 c_3 \\ 540+2 c_1=c_3 \\
\\
\text { At } x_1=6~m,~x_2=3~m,~\frac{d y_1}{d x_1}=-\frac{d y_2}{d x_2} \\
\\
\frac{80(6)^2}{2}-\frac{10(6)^3}{3}+c_1=-\frac{40(3)^2}{2}-c_3 \\ 1440-720+c_1=-180-c_3 \\ 900+c_1=-c_3 \\\end{gathered}
$$
...
5.  In cases where there is more than one region of load, apply continuity conditions to determine additional constants of integration. At the point where the loading changes:
...
In the previous section we used equilibrium to determine the equation of the internal bending moment and integrated this equation twice. This works well for relatively simple loading such as concentrated loads and uniformly or linearly distributed loads. For more complex loads, such as that shown in @fig-11.7, it can be difficult to determine the internal bending moment equation in this way. However, it is possible to avoid the need to do so.

![Complex external loads make it difficult to use equilibrium to determine the equation on the internal bending moment.](images/Chapter%2011%20image%20edits%20post%20review/figure%2011.7.png){#fig-11.7 fig-align="center" width="505"}
...
We may therefore relate the deflection of a beam to not only the internal bending moment, but also the internal shear force and external distributed load through successive integrations. For some loading configurations it can be simpler to integrate the distributed load equation 4 times instead of finding the equation of the internal bending moment through equilibrium and integrating twice. When doing this, remember that loads acting downwards (as most loads on beams do) are negative.
...
A simply supported beam is subjected to a distributed load w = 20 kN/m and a concentrated load F = 50 kN. If distance a = 6 m and b = 2 m, determine the deflection at the midpoint of the beam (x = 4 m).
...
&=-\frac{50000{~N}*2{~m}*4{~m}}{6*210 \times 10^9~\frac{N}{m^2}*275 \times 10^{-6}{~m^4}* 8{~m}}\left[(8~m)^2-(2~m)^2-(4~m)^2\right] \\
& =-~0.00635{~m} \\
& =-~6.35{~mm}
\end{aligned}
$$
...
![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.6%20part%201.png){fig-align="center" width="412"}
...
![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.6%20part%202.png){fig-align="center" width="405"}
...
![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.6%20part%203.png){fig-align="center" width="397"}

![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.6%20part%204.png){fig-align="center" width="404"}
...
![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.6%20part%205.png){fig-align="center" width="408"}
...
![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.7_last%20figure.png){fig-align="center" width="329"}
...
![](images/CH11%20PNGs/example11.7v2-1.png){fig-align="center" width="300"}
...
![](images/CH11%20PNGs/example11.7v2-2.png){fig-align="center" width="304"}
...
![](images/CH11%20PNGs/example11.7v2-3.png){fig-align="center" width="334"}
...
![](images/Chapter%2011%20image%20edits%20post%20review/example%2011.7%20(reworked)_last%20figure.png){fig-align="center" width="335"}
...
2.  Determine the deflection at the point that the reaction was removed. Use superposition if possible, or integration otherwise.
    ...
    1.  If the removed reaction was a moment, determine the slope at this point instead.
...
In @sec-9.2 we learned how to use the section modulus to design a beam to meet bending stress specifications. In practice, beams must also meet specifications for shear stress and deflection. Limitations will be placed on all three of these criteria and we must design our beams to meet all three simultaneously. We'll begin with rectangular cross-sections and then move on to standard beams using @sec-geometric-properties-of-standard-beams.
...
To meet the minimum required shear stress we will use $\tau=\frac{V Q}{I t}$. Using the method of @sec-10.1, it can be shown for a rectangle (@fig-11.10) that $Q=y A=\frac{h}{4} \frac{b h}{2}=\frac{b h^{2}}{8}$. Since $I=\frac{b h^{3}}{12}$ and $\mathrm{t}=\mathrm{b}$, we can re-write the shear stress equation to find the maximum shear stress in a rectangular cross-section as $\tau_{\max }=\frac{V \frac{b h^{2}}{8}}{\frac{b h^{3}}{12} b}=\frac{12 V b h^{2}}{8 b^{2} h^{3}}=\frac{12 V}{8 b h}=\frac{3}{2} \frac{V}{A}$.

![Rectangular cross-section showing the dimensions used for calculating the section modulus (S) and first moment of area (Q).](images/CH11%20PNGs/11.8.png){#fig-11.10 fig-align="center" width="270"}
...
![](images/CH11%20PNGs/example11.8-1.png){fig-align="center" width="423"}
...
![](images/CH11%20PNGs/example11.8-2.png){fig-align="center" width="323"}
...
For standard beams we can again use the method of @sec-9.2 to select a beam from @sec-geometric-properties-of-standard-beams that meets the specifications for bending stress. Use $S_{\min }=\frac{M_{\max }}{\sigma_{allow}}$ and select a beam with $\mathrm{S}>\mathrm{S}_{\min }$.
...
![](images/CH11%20PNGs/example11.9-1.png){fig-align="center" width="215"}
...
![](images/CH11%20PNGs/example11.9-2.png){fig-align="center" width="231"}
...
&W360\times134\quad(S=2340\times10^3~mm^3,I=416\times10^6~mm^4)\\
&W460\times113\quad(S=2390\times10^3~mm^3,I=554\times10^6~mm^4)\\
&W530\times101\quad(S=2290\times10^3~mm^3,I=616\times10^6~mm^4)\\
&W610\times125\quad(S=3210\times10^3~mm^3,I=986\times10^6~mm^4)\\
&W760\times147\quad(S=4410\times10^3~mm^3,I=1660\times10^6~mm^4)\\
\end{aligned}
$$
...
&=0.01098{~m}*0.536{~m} \\
&=0.0058853{~m}^2 \\
\tau=\frac{v_{max}}{A_{web}}=\frac{75000{~N}}{0.0058853{~m^2}}&=12.7{~MPa}
\end{aligned}
$$
