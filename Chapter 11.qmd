...
![Two example beams showing the undeflected position of the centerline (dotted line) and the deflected position of the elastic curve (solid line).](images/11.2.png){#fig-11.2 fig-align="center" width="552"}
...
![At pin and roller supports, the deflection is zero but the slope is not. At a fixed support, both the slope and deflection are zero. For a statically determinate beam in equilibrium we will always have two boundary conditions.](images/11.3%20new.png){#fig-11.3 fig-align="center" width="574"}
...
![](images/Example%2011.1.png){fig-align="center" width="250"}
...
![](images/Example%2011.1%20solution%201.png){fig-align="center" width="351"}
...
![](images/example%2011.1%20solution%202.png){fig-align="center" width="628"}
...
![](images/Example%2011.2.png){fig-align="center" width="250"}
...
![](images/example%2011.2%20solution.png){fig-align="center" width="700"}
...
![](images/Example%2011.3.png){fig-align="center" width="261"}
...
![](images/example%2011.3%20solution%201a.png){fig-align="center" width="241"}
...
![](images/example%2011.3%20solution%201b.png){fig-align="center" width="526"}
...
![](images/example%2011.3%20solution%201c.png){fig-align="center" width="521"}
...
$$
\begin{gathered}1800+6\left(720+c_3\right)=5040+6 c_3+c_4 \\1800+4320+6 c_3=5040+6 c_3+c_4 \\6120-5040=c_4 \\c_4=1080 \\\\\end{gathered}\\ \begin{gathered}c_4=-9 c_3-4720 \\c_3=\frac{-1080-9720}{9} \\c_3=-1200 \\\\\end{gathered}\\\begin{gathered}c_1=720+c_3=720-1200 \\c_1=-480\end{gathered}
...
![Simple beam showing two options for finding the internal bending moment. Note that the moment equation will be much simpler if we draw the right hand side of the cut.](images/11.4%20new.png){#fig-11.4 fig-align="center" width="513"}
...
![Depending on which side of the cut we draw, the deflection at point C will have the same magnitude and direction. The slope at point C will have the same magnitude but opposite directions if we make one cut from the left and the other from the right.](images/11.5.png){#fig-11.5 fig-align="center" width="667"}
...
![](images/Example%2011.3.png){fig-align="center" width="269"}
...
![](images/example%2011.3%20solution%202.png){fig-align="center" width="185"}
...
![](images/Example%2011.4.png){fig-align="center" width="278"}
...
Beams are typically loaded in a relatively small number of standard configurations, and the deflection behavior of a beam subjected to one of these standard loads is very well understood. A subset of beam deflections have been included in Appendix C. @fig-11.6 shows an example of the information provided for one such beam.

![Appendix C contains some standard loading configurations along with a sketch of the elastic curve, equations for the maximum deflection and maximum slope, and the general equation of the elastic curve.](images/11.9%20graphics/11.6.png){#fig-11.6 fig-align="center" width="831"}

This can be useful even for more complex loading. When multiple loads act on a beam, the effect of each load on the deflection of the beam may be considered independently. Thus, even for loading more complex than the loads in Appendix C, it may be possible to simplify the problem by considering each load separately and calculating the deflection caused at a point by each load (@fig-11.7). These deflections can then be added together to find the overall deflection at that point. We must of course calculate the deflection at the same point for each load in order to add them together. See [Example 11.5](#example-11.5) for a demonstration.

![Although Appendix C doesn't contain a cantilever beam with both a distributed load and a concentrated load, it does contain cantilever beams with each load separately. We may find the combined deflection by finding the deflection of each load separately and adding them together.](images/11.9%20graphics/11.7.png){#fig-11.7 fig-align="center" width="757"}
...
![](images/11.9%20graphics/example%2011.5.png){fig-align="center" width="272"}
...
![](images/11.9%20graphics/example%2011.5%20solutiona.png){fig-align="center" width="357"}
...
![](images/11.9%20graphics/example%2011.5%20solutionb.png){fig-align="center" width="364"}
...
![](images/11.9%20graphics/example%2011.6.png){fig-align="center" width="292"}
...
![](images/11.9%20graphics/example%2011.6%20solution.png){fig-align="center" width="470"}
...
![](images/11.9%20graphics/example%2011.6%20solutiona.png){fig-align="center" width="800"}
...
![](images/11.9%20graphics/example%2011.6%20solutionb.png){fig-align="center" width="332"}
...
![](images/11.9%20graphics/example%2011.7.png){fig-align="center" width="350"}
...
![](images/11.9%20graphics/example%2011.7%20solution%201a.png){fig-align="center" width="350"}
...
![](images/11.9%20graphics/example%2011.7%20solution1b.png){fig-align="center" width="350"}
...
![](images/11.9%20graphics/example%2011.7%20solution%202a.png){fig-align="center" width="350"}
...
![](images/11.9%20graphics/example%2011.7%20solution%202a%20copy.png){fig-align="center" width="350"}
...
![Rectangular cross-section showing the dimensions used for calculating the section modulus (S) and first moment of area (Q).](images/11.9%20graphics/11.8.png){#fig-11.8 fig-align="center" width="341"}
...
![](images/11.9%20graphics/example%2011.8.png){fig-align="center" width="464"}
...
![](images/11.9%20graphics/example%2011.8%20solution.png){fig-align="center" width="417"}
...
![](images/11.9%20graphics/example%2011.9.png){fig-align="center" width="350"}
...
![](images/11.9%20graphics/example%2011.9%20solution.png){fig-align="center" width="342"}
...
![](images/Kurt%20test%20problem1pt1.png){fig-align="center" width="276"}

::: {.callout-note collapse="true" icon="false"}
## Solution

![](images/Kurt%20test%20problem1pt2.png){fig-align="center" width="345"}
...
$$
J_{AB}=J_{BC}=\frac{\pi r^4}{2}=\frac{\pi 1^4}{2}=1.571~\mathrm{cm^4}
$$ $$
J_{CD}=\frac{\pi r^4}{2}=\frac{\pi (0.75)^4}{2}=0.4970~\mathrm{cm^4}
$$

Combining equations

$$
\frac{T_A}{1.571}+\frac{T_A-2}{1.571}=-\frac{T_a-2}{0.4970}
$$ $$
3.285 T_A=5.297
$$ $$
T_A=1.612~\mathrm{kN\cdot m}
$$
:::
:::
...
![](images/example%202%20q.png){fig-align="center" width="361"}

::: {.callout-note collapse="true" icon="false"}
## Solution

![](images/Kurt%20example%20pt1.png){fig-align="left" width="238"}
...
![](images/Kurt%20example%20pt2.png){fig-align="left" width="115"}
...
![](images/Kurt%20example%20pt3.png){fig-align="left" width="189"}
...
![](images/Kurt%20example%20pt4.png){fig-align="left" width="250"}
...
![](images/Kurt%20example%20pt5.png){fig-align="left" width="281"}
