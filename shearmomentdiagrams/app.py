...
prob_statement="Please draw shear and moment diagrams for the following cantilever beam of length L with forces of 25 lbs and 50 lbs applied at L/3 and 2L/3 respectively"
...
app_ui = ui.page_fluid(
    ...
    ui.panel_title("Interactive Shear and Moment Diagrams"),
        ui.row(
            ui.column(6,
