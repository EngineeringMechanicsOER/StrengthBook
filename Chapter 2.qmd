...
Normal stress occurs perpendicular to the cross-section and so is associated with either a pulling or pushing motion (@fig-2.1). Normal forces that pull on a cross-section are known as tensile forces and create a tensile normal stress. Normal forces that push on a cross-section are known as compressive forces and create a compressive normal stress. The normal stress calculated above is really an average normal stress as the force is distributed over the cross-section, but we generally simplify this to a concentrated force that creates the same normal stress at every point on the cross-section (@fig-2.2).

![Forces pulling on a cross-section cause tension, while forces pushing on a cross-section cause compression. Both are very common. Left: A crane cable during a lift experiences tension. Right: The support columns under a bridge experience compression.](images/CH2%20figures/2.1.png){#fig-2.1 fig-align="center"}

![The internal load is equally distributed over the cross-sectional area, but may be represented as a single concentrated load acting at the center (N in this case). The stress is therefore an average normal stress.](images/CH2%20figures/2.2.png){#fig-2.2 fig-align="center"}
...
![](images/Updated%20CH2%20examples/example%202.1%20part%201.png){fig-align="center" width="174"}
...
![](images/Updated%20CH2%20examples/example%202.1%20part%202.png){fig-align="center" width="136"}
...
![](images/Updated%20CH2%20examples/example%202.2%20part%201.png){fig-align="center" width="327"}
...
![](images/Updated%20CH2%20examples/example%202.2%20part%202.png){fig-align="center" width="270"}

![](images/Updated%20CH2%20examples/example%202.2%20part%203.png){fig-align="center" width="261"}
...
![](images/Updated%20CH2%20examples/example%202.2%20part%204.png){fig-align="center" width="236"}
...
![(a) External loads F creating (b) an internal normal force (N) perpendicular to the cross-section. (c) External loads F~1~, F~2~, and F~3~ creating (d) an internal shear force (V) parallel to the cross-section. Note that for diagram (d) to be in equilibrium there would also need to be an internal bending moment. That has been omitted here for clarity.](images/CH2%20figures/2.3.png){#fig-2.3 fig-align="center"}
...
![](images/Updated%20CH2%20examples/example%202.3%20part%201.png){fig-align="center" width="333"}
...
![](images/Updated%20CH2%20examples/example%202.3%20part%202.png){fig-align="center" width="328"}
...
![](images/Updated%20CH2%20examples/example%202.3%20part%203.png){fig-align="center" width="285"}
...
Shear stresses are common in both members of a structure and also in the fasteners between members. Depending on how these connections are formed we may see multiple shear planes. It is very important to correctly identify the internal force in the body. @fig-2.4 demonstrates the difference between single and double shear configurations for a pinned joint and the effects on internal shear force. See @exm-2.4 for an example where double shear occurs.

![Pins experiencing (a) single shear and (b) double shear.](images/CH2%20figures/2.4.png){#fig-2.4 fig-align="center"}
...
One common situation is contact between two curved edges, such as the bolt in @fig-2.6. In this situation it is common to use the projected contact area between the curved surfaces, which forms a rectangle of base d and height t. This greatly simplifies the calculation, but again represents an average value for the contact or bearing stress.
...
Figure 2.2: The internal load is equally distributed over the cross-sectional area, but may be represented as a single concentrated load acting at the center (N in this case). Kindred Grey. 2024. CC BY-NC-SA.
...
Figure 2.3: (a) External loads F creating (b) an internal normal force (N) perpendicular to the cross-section. Kindred Grey. 2024. CC BY-NC-SA.

Example 2.3: Kindred Grey. 2024. CC BY-NC-SA.

Figure 2.4: Pins experiencing (a) single shear and (b) double shear. Kindred Grey. 2024. CC BY-NC-SA.
...
Figure 2.6: When calculating the bearing stress between curved surfaces, project a rectangle of area A = d\*t. Kindred Grey. 2024. CC BY-NC-SA.

Figure 2.7: (a) External loads, F, will create (b) an internal normal force, N, when a cross-section is cut vertically. Kindred Grey. 2024. CC BY-NC-SA.

Figure 2.8: When calculating the stresses on an inclined plane, it is important to use the area of the plane, Ap, rather than the area of the cross-sectional plane, A. Kindred Grey. 2024. CC BY-NC-SA.
